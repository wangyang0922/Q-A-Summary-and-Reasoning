...
from utils.config import train_x_seg_path, train_y_seg_path, test_x_seg_path, batch_size, save_result_dir, \
    vocab_path, epochs, checkpoint_dir, val_x_seg_path, val_y_seg_path
...
def main():
    ...
    parser.add_argument("--gpu_memory", default=30, help="gpu_memory GB", type=int)
